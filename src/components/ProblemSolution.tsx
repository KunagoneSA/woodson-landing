    ...
    <>
      ...
      <section className="py-14 sm:py-18 bg-surface">
        <div ref={s1.ref} className={`max-w-4xl mx-auto px-8 lg:px-12 reveal ${s1.visible ? 'visible' : ''}`}>
          <span className="text-[11px] font-heading font-500 uppercase tracking-[0.3em] text-text-light">{t.problem.label}</span>
        ...
        <div className="max-w-6xl mx-auto px-8 lg:px-12">
          <div className="grid md:grid-cols-2 gap-20 items-center">
            <div ref={s2.ref} className={`reveal-left ${s2.visible ? 'visible' : ''}`}>
              <span className="text-[11px] font-heading font-500 uppercase tracking-[0.3em] text-accent/60">{t.solution.label}</span>
